...
up to 918 MiB/s compression and 1,956 MiB/s decompression; the experimental GPU
...
| | Co. | 46.2 | 2178 | 3.95 | 3.97 | 12.1 | **895** | **2754** |
| | De. | 359 | 1618 | 21.6 | 21.4 | 284 | **1378** | **8124** |
| chr6. | Ratio | 5.04 | 6.99 | 5.51 | 20.8 | 19.2 | **35.4** | **28.18** |
| | Co. | 41.0 | 1712 | 3.56 | 3.56 | 10.7 | **918** | **3791** |
| | De. | 348 | 1515 | 20.1 | 20.4 | 281 | **1136** | **7230** |
| E.coli | Ratio | 4.69 | 5.67 | 1.26 | 7.46 | 5.58 | **18.4** | **16.7** |
| | Co. | 33.3 | 1356 | 4.57 | 4.53 | 20.2 | **148** | **678** |
| | De. | 310 | 1258 | 34.0 | 32.2 | 197 | **470** | **1430** |
| HPRCv1.1 | Ratio | 4.02 | 5.32 | - | - | 14.0 | **22.4** | **20.4** |
| | Co. | 36.4 | 1657 | - | - | 84.5 | **259** | **4843** |
| | De. | 319 | 1234 | - | - | 650 | **1477** | **9435** |
| HPRCv2.0 | Ratio | 4.19 | 6.49 | - | - | 66.8 | **83.8** | **76.4** |
| | Co. | 49.1 | 1514 | - | - | 130 | **459** | **-** |
| | De. | 342 | 1240 | - | - | 648 | **1956** | **-** |
| HPRCv2.1 | Ratio | 4.19 | 6.43 | - | - | 64.2 | **82.8** | **74.2** |
| | Co. | 48.9 | 1540 | - | - | 136 | **436** | **-** |
| | De. | 343 | 1241 | - | - | 652 | **1821** | **-** |

`Ratio` indicates compression ratio; `Co.` and `De.` indicate compression
and decompression throughput in MiB/s. GFAz CPU values use 32 threads. Bold
values indicate the best result in each row. System configuration: AMD Ryzen
Threadripper PRO 9955WX (16 cores), NVIDIA RTX Pro 6000, and 512 GB DDR5-6400
memory.
